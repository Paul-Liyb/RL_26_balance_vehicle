...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--algo", choices=["sac", "td3", "ppo", "dqn"], required=True)
    ...
    parser.add_argument(
        ...
        help="Action interface. Defaults to discrete_direct for DQN and direct for continuous-control algorithms.",
    )
...
def main() -> int:
    ...
    action_mode = args.action_mode or ("discrete_direct" if args.algo == "dqn" else DEFAULT_ACTION_MODE)
